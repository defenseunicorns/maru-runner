...
func TestTaskRunner(t *testing.T) {
	...
	t.Run("run copy", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.Maru("run", "copy", "--file", "src/test/tasks/tasks.yaml")
	...
	t.Run("run copy-exec", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.Maru("run", "copy-exec", "--file", "src/test/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
	...
	t.Run("run copy-verify", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.Maru("run", "copy-verify", "--file", "src/test/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
	...
	t.Run("run copy-symlink", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.Maru("run", "copy-symlink", "--file", "src/test/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
	...
	t.Run("run local-import-with-curl", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.Maru("run", "local-import-with-curl", "--set", setVar, "--file", "src/test/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
	...
	t.Run("run template-file", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.Maru("run", "template-file", "--file", "src/test/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
	...
	t.Run("run local-import-set-variable automatic MARU variable is true", func(t *testing.T) {
		t.Parallel()

		stdOut, stdErr, err := e2e.Maru("run", "local-import-set-variable", "--file", "src/test/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
		require.Contains(t, stdErr, "I'm set automatically - MARU=true")
	})
